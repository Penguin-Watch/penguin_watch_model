#################
# 0 - Recovering gen values using one detection param vs many
# Recover generating values using one detection param vs many detection params
#
...
#RESULTS: Using 150 time steps and 'runif(1, 0.99, 0.9999)' for survival, one detection and ind detection params both recover generating values
