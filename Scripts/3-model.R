...
jagsRun(jagsData = DATA, 
               ...
               jagsInits = F_Inits,
               params = Pars,
               jagsID = 'May_8_2018_no_c_no_bp_trackpphi',
               jagsDsc = 'Fewer sites. Track phi and p. No covariates. No beta_phi. No partial pooling for eta_phi, gamma_phi, and nu_p (0.386 precision). Long queue.',
