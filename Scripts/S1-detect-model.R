...
jm1 <- rjags::jags.model(data = DATA,
                         file = 'pwatch_sim.jags',
                         inits = F_Inits,
                         n.chains = 3,
                         n.adapt = 5000)

stats::update(jm1, n.iter = 10000)

OUT1 <- rjags::coda.samples(jm1,
                            n.iter = 20000,
                            variable.names = Pars,
                            thin = 1)
...
jm2 <- rjags::jags.model(data = DATA,
                         file = 'pwatch_sim_one.jags',
                         inits = F_Inits,
                         n.chains = 3,
                         n.adapt = 5000)

stats::update(jm2, n.iter = 10000)

OUT2 <- rjags::coda.samples(jm2,
                            n.iter = 20000,
                            variable.names = Pars,
                            thin = 1)
