...
jagsRun(jagsData = DATA, 
        ...
        jagsInits = F_Inits,
        params = Pars,
        jagsID = 'May_26_2018_BUFF_6',
        jagsDsc = 'DAYS_BUFF_FIRST_CHICK = 6; 5 chains; logit(phi) <- mu + gamma + eta; logit(p) <- mu + beta*x + nu (hierarchical nu for site/year); Short queue',
